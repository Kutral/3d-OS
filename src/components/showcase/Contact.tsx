        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/kutral'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/kutraleeswaranb/'}
                    />
                    <SocialBox
                        icon={twitterIcon}
                        link={'tel:+919597581629'}
                    />
                </div>
            </div>
            <div className="text-block">
                <p>
                    I am currently an Incubation Intern at Zoho School for Graduate Studies.
                    I am eager to contribute to innovative web development opportunities.
